...
### [0.3.1](https://github.com/tianpai/kairos/compare/v0.3.0...v0.3.1) (2026-04-03)


### Features

* add Moonshot AI provider support ([31abcda](https://github.com/tianpai/kairos/commit/31abcda1d36c723b3be2163839f1a6b3fb8e49f7))
* improve providers settings UI layout and indicators ([eea4fbd](https://github.com/tianpai/kairos/commit/eea4fbd8d75df241b08e51f6fe9a33dfad04fa5d))
...
- Add semantic color palette with consistent theming
- Update sidebar and settings sidebar to have consistent width
- Add outline and danger variants to Button component

### Bug Fixes

- Batch export select all toggle state and styling
- New application button now checks active provider's API key
- Upload modal now closes when creating application
