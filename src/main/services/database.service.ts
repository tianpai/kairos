...
function createTables(): void {
  ...
  // Indexes
  sqlite.exec(`CREATE INDEX IF NOT EXISTS idx_job_applications_company_id ON job_applications(company_id)`)
  sqlite.exec(`CREATE INDEX IF NOT EXISTS idx_job_applications_created_at ON job_applications(created_at)`)
